...
export class Backend implements backendInterface {
    ...
    async addMovie(arg0: string, arg1: string, arg2: bigint, arg3: bigint, arg4: string, arg5: string, arg6: string): Promise<void> {
    ...
    async addToList(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getList(): Promise<Array<Movie>> {
        if (this.processError) {
            try {
                const result = await this.actor.getList();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeFromList(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeFromList(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
